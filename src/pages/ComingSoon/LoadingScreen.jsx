...
const LoadingScreen = ({ isLoading }) => {
  return (
    ...
    >
      <div className="text-center text-white flex flex-col items-center w-full h-full justify-center">
        {/* Starry Cube SVG fills the screen */}
        <div className="absolute inset-0 flex items-center justify-center w-full h-full">
          <div className="w-full h-full animate-spin-slow">
            <svg width="100%" height="100%" viewBox="0 0 512 512" fill="none" overflow="hidden" xmlns="http://www.w3.org/2000/svg">
              ...
              <defs>
                ...
                <path id="star11" strokeWidth="3">
                  <animate attributeName="d" dur="6s" repeatCount="indefinite" begin="3s"
                    keyTimes="0;0.90;0.95;1"
                    keySplines="0 0.4 1 0.2; 0 0.4 1 0.2; 0 0.4 1 0.2"
                    values="M64 0 L64 0Z; M64 0 L64 0Z; M48 12 L0 48Z; M0 48 L0 48Z"/>
                  <animate attributeName="opacity" dur="6s" repeatCount="indefinite" begin="3s"
                    keyTimes="0;0.90;0.95;1"
                    values="1; 1; 0.6; 0"/>
                </path>
              </defs>
        ...
        {/* Loading text */}
        <div className="relative z-10 flex flex-col items-center justify-end w-full h-full mb-15">
          <h2 className="futura-light text-2xl font-bold mb-4 mt-8"
          style={{
          color: '#F9E3E7',
          textShadow:
            '-1px -1px 0 #bf1736, 1px -1px 0 #bf1736, -1px 1px 0 #bf1736, 1px 1px 0 #bf1736',
          }}>Loading Experience</h2>
          {/* Bouncing dots */}
