  ...
  return (
   ...
   <div className="overlay-wrapper w-full h-full select-none text-white">
      ...
      <div className={`intro-wrapper absolute inset-0 h-full w-full flex flex-col justify-center items-center z-0 ${hasScroll ? "intro-wrapper-disable" : ""}`}>
          ...
          <button className={`intro-button bg-white text-black text-[11px] md:text-[13px] lg:text-[15px] px-2 py-1 md:px-3 md:py-1 lg:px-4 lg:py-2 rounded-full border-none inline-block relative overflow-hidden absolute top-20 sm:top-25 md:top-35 transform  ${play ? "intro-button-disappear" : ""}`}
            onClick={() => {
              setPlay(true);
            }}
          >
      ...
      <div className={`outro-wrapper absolute inset-0 w-full h-full perspective-[1500px] justify-center items-center pointer-cursor flex ${end ? "outro-wrapper--appear" : ""}`}>
          ...
          <div className={`outro-content relative rounded-4xl h-[30%] sm:h-[35%] md:h-[40%] lg:h-[45%] xl:h-[50%] 2xl:h-[50%] aspect-[16/9] ${cardFlipped ? "outro-content--flipped" : ""}`}>
            ...
            <div className="front-side absolute w-full h-full rounded-4xl flex flex-col justify-between p-8">
              ...
              <div className="text-svg-wrapper basis-1/2 flex flex-col justify-end items-center">
                <div className="text whitespace-nowrap text-[12px] md:text-[18px]">Our new site’s in the clouds for now. Launching soon!</div>
            ...
            <div className="back-side absolute h-full w-full rounded-4xl flex flex-col justify-between p-1 sm:p-3 md:p-3 lg:p-4">
              ...
              <div className="upper-wrapper basis-1/3 flex justify-center items-center">
                <div className="display-text text-[12px] md:text-[16px] leading-[24px] text-center">
              ...
              <div className="middle-wrapper text-[12px] md:text-[16px] basis-1/3 flex justify-between items-center px-2">
              ...
              <div className="lower-wrapper basis-1/3 flex justify-between items-end">
                 <div className="sound-wrapper basis-1/3">
                  <img
                    ...
                    alt="Sound"
                    className="arrow-svg h-7 w-7 mb-2 ml-2 cursor-pointer"
