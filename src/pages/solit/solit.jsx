  ...
  return (
    <>
      <div ref={container} className="w-full overflow-hidden">
        ...
        {/* First container */}
        <div className="border pointer-events-none z-50 container mx-auto flex flex-col items-center gap-y-8 p-8 md:gap-y-0 lg:gap-y-16 lg:px-10 lg:py-16 lg:pb-12 xl:gap-y-28 xl:pb-32 2xl:gap-y-20">
          <PageBreadcrumbs />
        ...
        <div className="border z-50 container mx-auto flex flex-col items-center p-8 sm:p-0 md:p-8 lg:p-8 xl:p-8 2xl:p-0 lg:pb-[130px] xl:pb-[130px] 2xl:pb-[130px] gap-y-8 sm:gap-y-8 md:gap-y-12 lg:gap-y-16 xl:gap-y-28 2xl:gap-y-[130px]">
          <MainText />
        ...
        {/* Second container */}
        <div className="border z-50 container mx-auto flex flex-col items-center p-8 sm:p-0 md:p-0 lg:p-0 xl:p-8 2xl:p-0 lg:px-0 lg:py-0 lg:pt-[130px] xl:pt-[130px] 2xl:pt-[130px] lg:pb-[130px] xl:pb-[130px] 2xl:pb-[130px] gap-y-8 sm:gap-y-8 md:gap-y-12 lg:gap-y-16 xl:gap-y-28 2xl:gap-y-[130px]">
          <Sectionidea
            title={{
        ...
        <div className="border z-50 container mx-auto flex flex-col items-center 2xl:pt-[0px] lg:px-0 lg:py-0 lg:pb-[130px] xl:pb-[130px] gap-y-8  md:gap-y-12 lg:gap-y-28 xl:gap-y-28 2xl:gap-y-[130px]">
          {/* Slider */}
          <Display>
            <Slider />
          </Display>
        </div>
        <div className="border z-50 container mx-auto flex flex-col items-center 2xl:pt-[0px] lg:px-0 lg:py-0 lg:pb-0 xl:pb-[130px] gap-y-8  md:gap-y-12 lg:gap-y-[130px] xl:gap-y-28 2xl:gap-y-[130px]">
        <div className="flex w-full flex-col items-center gap-8 lg:flex-row lg:gap-16 xl:gap-16">
          ...
          <Display>
            ...
            <div className="absolute inset-0 z-50 flex flex-col items-center justify-between p-8 lg:items-start lg:justify-center md:p-20 lg:p-16 xl:p-24">
              <h3 className="Futura-PT-Bold text-center text-white text-5xl md:text-6xl lg:text-left lg:text-8xl xl:w-2/3 xl:text-8xl 2xl:text-9xl">
